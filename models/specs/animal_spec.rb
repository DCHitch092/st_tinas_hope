...
class VetTest < MiniTest::Test
  ...
  def test_new_animal__no_age()
    ...
    result = animal_no_age.new_animal()
    assert_equal(9, result.age)
  end

  # def test_new_animal__no_dob()
  #   animal_no_age = Animal.new(
  #     { 'name' => 'test_boy',
  #       'date_of_birth' => '',
  #       'type' =>  'dog',
  ...
  #       'age' => '9'})
  #
  #   animal_no_age.new_animal()
  #   result = :date_of_birth
  #   assert_equal('2010-11-09', result)
  # end
